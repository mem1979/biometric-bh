 ...
 * Generated at: 2026-07-31 19:49:20 UTC
...
private static Log log = LogFactory.getLog("index.jsp"); 
  ...
  static {
    ...
    _jspx_dependants.put("/naviox/indexExt.jsp", Long.valueOf(1785527333914L));
...
manager.registerAction("SessionLocker.lock");
 ...
 if (XavaPreferences.getInstance().isChatAvailable() && Users.getCurrent() != null && modules.isChatAvailable()) { 
      ...
      out.write("<script type=\"text/javascript\">\n");
      out.write("(function() {\n");
      out.write("    function fixDropdowns() {\n");
      out.write("        var dropdowns = document.querySelectorAll('.dropdown-toggle, [data-bs-toggle=\"dropdown\"], [data-toggle=\"dropdown\"]');\n");
      out.write("        for (var i = 0; i < dropdowns.length; i++) {\n");
      out.write("            dropdowns[i].classList.remove('xava_action');\n");
      out.write("        }\n");
      out.write("    }\n");
      out.write("\n");
      out.write("    // Run immediately when loaded\n");
      out.write("    fixDropdowns();\n");
      out.write("\n");
      out.write("    // Run on window load\n");
      out.write("    window.addEventListener('load', fixDropdowns);\n");
      out.write("\n");
      out.write("    // Monitor DOM changes to apply the fix dynamically after AJAX refreshes\n");
      ...
      out.write("        setInterval(fixDropdowns, 500);\n");
      out.write("    }\n");
      out.write("})();\n");
      out.write("</script>");
      out.write("\r\n");
